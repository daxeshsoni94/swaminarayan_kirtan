...
const PlaceShowPads = ({ swami, pads = [] }: { swami: any; pads?: any[] }) => {
                                ...
                                <Card.Body className="p-0">
                                    {pads.length === 0 ? (
                                        <div className="text-center py-5 text-muted">
                                            {isGu
                                                ? "આ સ્થળ સાથે કોઈ પદ જોડાયેલ નથી."
                                                : "No pads found for this place."}
                                        </div>
                                    ) : (
...
PlaceShowPads.layout = (page: any) => <Layout children={page} />;
