...
/**
 * @typedef {Object} PaginatedBhavs
 * @property {BhavItem[]} data
...
const translations = {
    en: {
        ...
        title: "Bhavs",
        pageTitle: "Bhavs",
        searchPlaceholder: "Search by bhav name…",
        noData: "No bhavs found.",
        deleteSuccess: "Bhav deleted successfully.",
        bulkDeleteSuccess: "Bhavs deleted successfully.",
        bulkDeleteFail: "Failed to delete bhavs.",
        selectAtLeastOne: "Select at least one bhav.",
        view: "View",
        edit: "Edit",
        delete: "Delete",
        showing: "Showing",
    ...
    gu: {
        ...
        title: "ભાવની યાદી ",
        pageTitle: "ભાવ",
        searchPlaceholder: "ભાવ  શોધો…",
        noData: "કોઈ ભાવ  મળી નથી.",
        deleteSuccess: "ભાવ  સફળતાપૂર્વક કાઢી નાખવામાં આવી.",
        bulkDeleteSuccess: "ભાવ  સફળતાપૂર્વક કાઢી નાખવામાં આવી.",
        bulkDeleteFail: "ભાવ  કાઢી નાખવામાં નિષ્ફળતા.",
        selectAtLeastOne: "ઓછામાં ઓછું એક ભાવ  પસંદ કરો.",
        view: "જુઓ",
        edit: "ફેરફાર કરો",
        delete: "કાઢી નાખો",
...
const BhavList = ({ bhavs, filters }) => {
    ...
    const [data, setData] = useState(bhavs?.data ?? []);
...
BhavList.layout = (page) => <Layout children={page} />;
