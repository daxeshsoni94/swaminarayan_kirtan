                                ...
                                <div className="text-center mt-sm-5 mb-4 text-white-50">
                                    <div>
                                        <Link href='/' className="d-inline-block auth-logo">
                                            <img src={logoLight} alt="" height="60" style={{ borderRadius: "30px" }}/>
                                        </Link>
                                    </div>
                                    <p className="mt-3 fs-15 fw-medium">Manage and explore divine Swaminarayan Kirtans</p>
                                </div>
                            </Col>
                        </Row>
                                ...
                                <Card className="mt-4">
                                    <Card.Body className='p-4'>
                                        <div className="text-center mt-2">
                                            ...
                                            <p className="text-muted">Sign in to continue to KirtanHub.</p>
                                        </div>
